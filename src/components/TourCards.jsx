...
const TourCards = ({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {tours.map((tour) => {
        // Check if this is a completed unpaid tour
        const isCompletedUnpaid = isPastTour(tour.date, tour.time) && !tour.paid;
        ...
        return (
          ...
          >
            <div className={`px-4 py-3 ${getHeaderClass(tour.date, tour.time, tour.cancelled)}`}>
                ...
                <div className="flex items-center space-x-2">
                  {!tour.cancelled && (
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-full flex items-center transition-colors duration-200 ${
                        tour.paid 
                  ...
                  {tour.cancelled && (
                    <span className="text-xs px-3 py-1.5 rounded-full flex items-center bg-red-100 text-red-800">
            ...
            <div className="p-4">
              <h2 className="text-gray-900 font-medium text-lg mb-2">{tour.title}</h2>
              
              {tour.cancelled && (
                <div className="bg-red-50 border-l-4 border-red-400 text-red-700 p-3 mb-3 rounded">
                  <div className="flex">
