...
const Layout = ({ children }) => {
  const { logout, isAdmin, userRole, userName } = useAuth();
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              {/* User name indicator */}
              <span className="mr-4 text-sm text-gray-700 font-semibold">
                {userName}
              </span>
              {/* Mobile menu button */}
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="sm:hidden inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-purple-500"
              >
