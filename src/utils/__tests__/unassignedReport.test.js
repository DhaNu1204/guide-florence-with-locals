...
describe('buildUnassignedReportText', () => {
  it('one line per DEPARTURE, grouped by date and sorted by time', () => {
    const text = buildUnassignedReportText(
      [
        { tour_unit: 't9', date: '2026-09-20', time: '14:15', title: 'Uffizi & Accademia Walking Tour', bookings: 1, pax: 2, language: 'Spanish' },
        { tour_unit: 'g12', date: '2026-09-19', time: '10:30', title: 'Uffizi Gallery Guided Tour', bookings: 4, pax: 9, language: 'English, Italian' },
