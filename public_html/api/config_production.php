<?php
// Production MySQL database configuration for Hostinger
// TODO: Replace with actual Hostinger database credentials

$db_host = 'localhost'; // Hostinger MySQL host
$db_user = 'u803853690_withlocals'; // Actual Hostinger database username
$db_pass = '***REMOVED***'; // Actual Hostinger database password
