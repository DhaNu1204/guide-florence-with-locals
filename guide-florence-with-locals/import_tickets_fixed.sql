-- Import tickets data (FIXED VERSION)
-- Run this AFTER adding the time column

-- First, let's clear any existing test data if needed
-- DELETE FROM tickets WHERE code LIKE '181%';

-- Import the new ticket data
...
SELECT COUNT(*) as new_tickets FROM tickets WHERE code LIKE '181%'; 